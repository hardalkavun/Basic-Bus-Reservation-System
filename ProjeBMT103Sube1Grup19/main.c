...
int main()
{
    ...
    biletleriDosyadanOku(biletler, &seferSayisi);
    // Ana menü
    int secim;
            ...
            case 1: {
                ...
                for (int i = 0; i < SEFER_SAYISI; i++)                                       //for döngüsünün sebebi bilet oluşturma aşamasında 10 tane farklı bilet oluşturmak için.
                    {
                        ...
                        int saatler[24];
                         ...
                         // Firma seçimi
                         int firmaSayi = rand() % 3;              // rastgele 3 firmadan biri seçilir

                          // Dolu koltuk sayısı ve numaralarının belirlenmesi
                ...
                do
                    ...
                    if (!koltukVar) {        //koltuk dolu değilse if bloğu çalışır
                        ...
                        biletleriDosyayaYaz(biletler, SEFER_SAYISI, satinAlmaBilgileri.biletIndex, satinAlmaBilgileri.koltukNo);
